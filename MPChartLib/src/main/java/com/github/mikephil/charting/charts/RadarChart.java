...
public class RadarChart extends PieRadarChartBase<RadarData> {
     ...
     * 是否禁用从中心点到边线之间的直线
     */
    private boolean noRenderXAisLine = false;

    /**
     * 是否绘制填充线小圆点
     */
    private boolean isRenderXAisCircle = false;

    /**
     * 是否使用雷达自定义样式
     */
    private boolean isRadarCustomStyle = false;
...
//            mYAxisRenderer.computeAxis(mYAxis.mAxisMinimum, mYAxis.mAxisMaximum, mYAxis.isInverted());
    ...
    public boolean isNoRenderXAisLine() {
        return noRenderXAisLine;
    }

    public void setNoRenderXAisLine(boolean noRenderXAisLine) {
        this.noRenderXAisLine = noRenderXAisLine;
    }

    public boolean isRenderXAisCircle() {
        return isRenderXAisCircle;
    }

    public void setRenderXAisCircle(boolean renderXAisCircle) {
        isRenderXAisCircle = renderXAisCircle;
    }

    public boolean isRadarCustomStyle() {
        return isRadarCustomStyle;
    }

    public void setRadarCustomStyle(boolean radarCustomStyle) {
        isRadarCustomStyle = radarCustomStyle;
    }
}
