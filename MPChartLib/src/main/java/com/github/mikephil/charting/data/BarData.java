...
public class BarData extends BarLineScatterCandleBubbleData<IBarDataSet> {
     ...
     * 是否柱条为圆角
     */
    private boolean isBarCharRaduis = false;

    public boolean isBarCharRaduis() {
        return isBarCharRaduis;
    }

    public void setBarCharRaduis(boolean barCharRaduis) {
        isBarCharRaduis = barCharRaduis;
    }
