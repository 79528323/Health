...
public abstract class AxisBase extends ComponentBase {
     ...
     * 自定义雷达图边角字体显示
     */
    protected boolean isDrawRadarLabelValue = false;

    public boolean ismIsDrawScale() {
        return mIsDrawScale;
    }

    public void setmIsDrawScale(boolean mIsDrawScale) {
    ...
    public void setmEntries(float[] mEntries) {
        this.mEntries = mEntries;
    }

    public void setmEntryCount(int mEntryCount) {
        this.mEntryCount = mEntryCount;
    }
    ...
    public boolean isDrawRadarLabelValueEnabled() {
        return isDrawRadarLabelValue;
    }

    public void setDrawRadarLabelValue(boolean drawRadarLabelValue) {
        isDrawRadarLabelValue = drawRadarLabelValue;
    }
