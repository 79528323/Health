...
public class UpdateAppManager {
     ...
     */
    public static void download(final Context context, @NonNull final UpdateAppBean1 updateAppBean,
...
//    }
     ...
     * @return 新版本信息
     */
    public UpdateAppBean1 fillUpdateAppData() {
        if (mUpdateApp != null) {
    ...
    private boolean verify() {
        //版本忽略
        if (mShowIgnoreVersion && AppUpdateUtils.isNeedIgnore(mActivity, mUpdateApp.getData().getVersionName())) {
            return true;
        }
