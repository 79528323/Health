package net.fkm.updateapp.utils;
...
public class AppUpdateUtils {
    ...
    public static File getAppFile(UpdateAppBean1 updateAppBean) {
        String appName = getApkName(updateAppBean);
        return new File(updateAppBean.getTargetPath()
                .concat(File.separator + updateAppBean.getData().getVersionName())
                .concat(File.separator + appName));
    }

    @NonNull
    public static String getApkName(UpdateAppBean1 updateAppBean) {
        String apkUrl = updateAppBean.getData().getUrl();
    ...
    public static boolean appIsDownloaded(UpdateAppBean1 updateAppBean) {
        //md5不为空
        //文件存在
        //md5只一样
