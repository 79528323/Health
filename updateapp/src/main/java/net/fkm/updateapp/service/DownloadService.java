package net.fkm.updateapp.service;
...
import net.fkm.updateapp.HttpManager;
import net.fkm.updateapp.R;
...
//            channel.setVibrationPattern(new long[]{100, 200, 300, 400, 500, 400, 300, 200, 400});
     ...
     * 下载模块
     */
    private void startDownload(UpdateAppBean1 updateApp, final DownloadCallback callback) {

        mDismissNotificationProgress = updateApp.isDismissNotificationProgress();

        String apkUrl = updateApp.getData().getUrl();
        ...
        String target = appDir + File.separator + updateApp.getData().getVersionName();
    ...
    public class DownloadBinder extends Binder {
         ...
         * @param callback  下载回调
         */
        public void start(UpdateAppBean1 updateApp, DownloadCallback callback) {
            //下载
