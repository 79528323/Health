...
public class ChooseWaysUtils extends PopupWindow implements View.OnClickListener {
    ...
    private TextView tv_pic_sourse, tv_select_photos, tv_take_camera, tv_cancle;
    private DialogOnItemClickListener mDialogOnItemClickListener;
    private View view;

    public ChooseWaysUtils(Context context, DialogOnItemClickListener dialogOnItemClickListener, String des, String des1, String des2) {
        super(context);
        this.context = context;
        this.mDialogOnItemClickListener = dialogOnItemClickListener;
        view = View.inflate(context, R.layout.dialog_choose_ways, null);
        tv_pic_sourse = (TextView) view.findViewById(R.id.tv_pic_sourse);
        ...
        tv_pic_sourse.setText(des);
        tv_select_photos.setText(des1);
        tv_take_camera.setText(des2);

        tv_select_photos.setOnClickListener(this);
        tv_cancle.setOnClickListener(this);
        tv_take_camera.setOnClickListener(this);
        tv_pic_sourse.setOnClickListener(this);
...
//		this.setAnimationStyle(R.style.AnimBottom);
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.tv_pic_sourse) {
            mDialogOnItemClickListener.onItemClickListener(view, 2);
