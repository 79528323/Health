...
public class NetworkUtils {
    ...
    public static boolean getDataEnabled() {
        try {
            TelephonyManager tm = (TelephonyManager) HealthApp.getInstance().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static boolean isAvailableByPing() {
        ...
        if (result.errorMsg != null) {
            Logger.e("isAvailableByPing errorMsg", result.errorMsg);
        }
        if (result.successMsg != null) {
            Logger.e("isAvailableByPing successMsg", result.successMsg);
        }
        return ret;
    }
