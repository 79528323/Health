...
public class FamilyMemberAdapter extends BaseQuickAdapter<FamilyMember.DataBeanX.DataBean.HealthDataBean, BaseViewHolder> {
    ...
    @Override
    protected void convert(BaseViewHolder helper, FamilyMember.DataBeanX.DataBean.HealthDataBean item) {
