...
public class EducationButton extends Button {
    private int WIDTH;
    private int HEIGHT;
    ...
    public EducationButton(Context context) {
        super(context);
    }

    public EducationButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public EducationButton(Context context, AttributeSet attrs, int defStyle) {
