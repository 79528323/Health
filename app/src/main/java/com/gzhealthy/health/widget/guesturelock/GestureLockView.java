...
public class GestureLockView extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            NORMAL_COLOR = Color.parseColor("#FFAAAAAA");
            ERROR_COLOR = Color.parseColor("#FFFE5252");
        }
        ppath = new PWDPath();
    }
    ...
    private class PPoint {
        ...
        public void setnPointpPaint(Paint nPointpPaint) {
            this.nPointpPaint = nPointpPaint;
        }
    ...
    private class PWDPath {
        ...
        public PWDPath() {
            pwdps = new LinkedHashSet<PPoint>();
            path = new Path();
            pathStart = new Path();
        ...
        public void draw(Canvas c, boolean isRight) {
            nPaint.setColor(Color.parseColor("#ff03B68f"));

            if (isRight) {
                c.drawPath(path, nPaint);
                for (PPoint point : pwdps) {
                    point.getnPointpPaint().setColor(Color.parseColor("#ff03B68f"));
