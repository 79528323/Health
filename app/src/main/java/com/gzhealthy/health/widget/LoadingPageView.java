...
import static com.gzhealthy.health.base.Constants.ResponseStatus.STATE_EMPTY;
import static com.gzhealthy.health.base.Constants.ResponseStatus.STATE_ERROR;
import static com.gzhealthy.health.base.Constants.ResponseStatus.STATE_LOADING;
import static com.gzhealthy.health.base.Constants.ResponseStatus.STATE_SUCCESS;
import static com.gzhealthy.health.base.Constants.ResponseStatus.STATE_UNKNOWN;
...
//    private ImageView img;
    ...
    private void init() {
        this.setBackgroundColor(getResources().getColor(R.color.window_background_color));
    ...
    private View createLoadingView() {
        loadingView = LayoutInflater.from(mContext).inflate(R.layout.view_state_loading, null);
...
//        }
    ...
    private View createEmptyView() {
        emptyView = LayoutInflater.from(mContext).inflate(R.layout.view_state_empty, null);
        return emptyView;
    }

    private View createErrorView() {
        errorView = LayoutInflater.from(mContext).inflate(R.layout.view_state_error, null);
