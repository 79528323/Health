 ...
 * on 2021/4/25
 */
public class CalendarFamilyDailog extends Dialog implements CalendarView.OnMonthChangeListener
    ...
    public CalendarFamilyDailog(Context context, RxManager rxManager, OnSelectCalendarCallback onSelectCalendarCallback) {
...
//     */
//    public CalendarFamilyDailog(Context context, RxManager rxManager, OnSelectCalendarCallback onSelectCalendarCallback, boolean isOverNoSelect) {
//        super(context);
...
//        int resouce = isOverNoSelect ? R.layout.popup_sleep_calendar_window :
        View contentView = LayoutInflater.from(context).inflate(R.layout.calendar_family_window,null);
        ...
        params.y = 0;//Dialog距离底部距离
        window.setBackgroundDrawableResource(R.drawable.bg_rect_radius);
