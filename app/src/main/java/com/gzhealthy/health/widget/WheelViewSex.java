...
public class WheelViewSex extends View {
    private static final String TAG = "WheelViewToAirTicket";
    /**
     * 刷新界面
     */
    ...
    public WheelViewSex(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context, attrs);
        initData();
    }

    public WheelViewSex(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
        initData();
    }

    public WheelViewSex(Context context) {
        super(context);
        initData();
    }
...
//        }
    ...
    private void drawMask(Canvas canvas) {
        LinearGradient lg = new LinearGradient(0, 0, 0, unitHeight, 0x55ffffff,
                0x55ffffff, Shader.TileMode.MIRROR);
        ...
        LinearGradient lg2 = new LinearGradient(0, controlHeight - unitHeight,
                0, controlHeight, 0x55ffffff, 0x55ffffff, Shader.TileMode.MIRROR);
