 ...
 * 健康报告
 */
public class HealthyHRVReportActivity extends BaseAct {
...
////    TextView tv_report_get;
    ...
    protected int getContentLayout() {
        return R.layout.activity_healthy_hrv_report;
    }
...
//        RxBus.getInstance().postEmpty(RxEvent.ON_REFRESH_REPORT_BUTTON_STATUS);
    ...
    public static void instance(Context context){
        context.startActivity(new Intent(context, HealthyHRVReportActivity.class));
    }
